...
export const reviewPlatforms: ReviewPlatform[] = [
  ...
  { name: "Jerkmate", category: "Live Cam Sites", score: 7.2, slug: "jerkmate", description: "The most-advertised cam site on the internet — we signed up behind the ads to test the ranked system, Gold shows, and whether the curated matching delivers. 7.2/10." },
