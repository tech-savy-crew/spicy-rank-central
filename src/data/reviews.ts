...
export const reviewPlatforms: ReviewPlatform[] = [
  ...
  { name: "GirlfriendGPT", category: "AI Companions", score: 7.2, slug: "girlfriendgpt", description: "Open-source AI girlfriend platform with uncensored models. Good customization but requires some technical knowledge." },
  ...
  { name: "Patreon", category: "Creator Platforms", score: 7.0, slug: "patreon", description: "The mainstream creator subscription platform where credibility comes standard but the fee structure (5-12% + processing) demands your attention." },
  ...
  { name: "LiveJasmin", category: "Live Cam Sites", score: 7.2, slug: "livejasmin", description: "Premium cam site known for high-quality HD streams and professional models. Expensive but the production quality is top-tier." },
  { name: "Jerkmate", category: "Live Cam Sites", score: 7.2, slug: "jerkmate", description: "The most-advertised cam site on the internet — we signed up behind the ads to test the ranked system, Gold shows, and whether the curated matching delivers." },
  { name: "Flirt4Free", category: "Live Cam Sites", score: 7.0, slug: "flirt4free", description: "28 years old and still running the best fetish section on any cam site. Hybrid free and premium model with community forums." },
  ...
  { name: "Adult Friend Finder", category: "Dating & Hookup Apps", score: 6.5, slug: "adult-friend-finder", description: "The internet's oldest surviving hookup platform — 80 million registered members, the most established swinger community, and an interface from another era." },

  // Fetish & Niche Marketplaces (3)
  { name: "FeetFinder", category: "Fetish & Niche Marketplaces", score: 8.0, slug: "feetfinder", description: "The largest dedicated marketplace for foot content creators. High earnings potential with a focused, active buyer community." },
  { name: "FetishFinder", category: "Fetish & Niche Marketplaces", score: 7.5, slug: "fetishfinder", description: "Niche fetish content marketplace connecting creators with enthusiasts. Good discovery features for specialized content." },
  { name: "Snifffr", category: "Fetish & Niche Marketplaces", score: 7.2, slug: "snifffr", description: "Marketplace for selling worn items with built-in messaging. Niche but loyal user base with decent earning potential." },
];
