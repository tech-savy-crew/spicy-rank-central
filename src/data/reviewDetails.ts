  ...
  return [
    ...
    },
    {
      ...
      pricingDetails: [
        ...
        { plan: "Seller Premium", price: "$14.99/mo", features: ["Everything in Basic plus priority placement in search results", "Premium badge on your profile", "Access to analytics tools", "Higher visibility and**What is the real FeetFinder cost?** If you are on the Basic plan, you pay $4.99 per month plus 20% of every sale. If you sell $500 worth of content in a month, your take-home after FeetFinder fees would be roughly $395. That is still a strong return compared to finding buyers independently.\n\n**How much can you actually earn?** FeetFinder income varies wildly depending on content quality, consistency, and marketing effort:\n\n- Beginners typically earn **$50 to $200** per month in their first three months\n- Consistent mid-level sellers average **$300 to $1,000** monthly\n- Top performers report FeetFinder salary figures of **$2,000 to $5,000+** per monthFinder salary figures of $2,000 to $5,000 or more per month.",
      scores: [
