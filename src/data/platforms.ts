...
export const platforms: Platform[] = [
  ...
  },
  {
    ...
    reviewSections: [
      ...
      {
        title: "Pricing & Value Analysis",
        content: "Fansly's pricing structure is more flexible and creator-friendly than OnlyFans, with a lower commission and tiered subscription options.\n\n**Commission & Revenue Split:**\n- Platform fee: **15%** (vs OnlyFans' 20%)\n- Creator keeps: **85%** of all earnings\n- On $5,000/month earnings: **$4,250** take-home (vs $4,000 on OnlyFans)\n- Annual savings vs OnlyFans: **$3,000** on $5K/month earnings\n\n**Subscription Options:**\n- Minimum subscription price: **$4.99/month**\n- Multiple tiers supported (e.g., Basic $5.99, Premium $14.99, VIP $29.99)\n- Free tiers available with limited content as a preview\n- Bundle discounts for multi-month commitments\n\n||| Fansly vs OnlyFans Pricing |||\n| Feature | Fansly | OnlyFans |\n| Platform Fee | 15% | 20% |\n| Creator Take-Home | 85% | 80% |\n| Subscription Tiers | Multiple | Single |\n| Crypto Payments | Yes | No |\n| Min Payout | $100 | $20 |\n| Payout Frequency | Bi-weekly | Weekly |\n\n**Additional Revenue Streams:** Tips, pay-per-view messages, and custom content requests provide extra earning opportunities. Fansly also supports cryptocurrency payments (Bitcoin, Ethereum), giving fans a privacy-friendly payment option unavailable on OnlyFans.\n\n**Payout Details:** Payouts are processed **bi-weekly** with a minimum threshold of **$100** — higher than OnlyFans' $20 minimum, which can be a disadvantage for newer creators with lower earnings."
      },
      {
        title: "User Experience & Interface",
