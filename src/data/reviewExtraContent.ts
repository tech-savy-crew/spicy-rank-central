...
const uxOverrides: Record<string, UserExperienceContent> = {
  ...
  "chaturbate": {
    gettingStarted: "Creating a Chaturbate account takes under two minutes with just an email address. However, no account is needed for basic viewing — you can watch any public broadcast immediately upon visiting the site. Account creation enables chat participation, following performers, and receiving notifications. Token purchases require account creation and a payment method. The registration barrier is essentially zero for viewers.",
    interfaceNavigation: "Chaturbate's interface is, to put it diplomatically, functional rather than beautiful. The homepage presents a massive grid of performer thumbnails sorted by current viewer count, with category tabs along the top (Female, Male, Couples, Trans). The design has barely evolved since the platform's early years — it looks like a website from 2010 dropped into the modern web. Navigation works: you can filter by category, tag, region, and number of viewers. But the visual design, typography, and overall aesthetic are dated and unappealing compared to competitors like Stripchat's modern interface.\n\nHere is the thing: the dated interface does not seem to matter. Chaturbate's 5 million daily visitors prove that scale, content quality, and free access trump interface aesthetics in the cam industry. The platform is ugly and it wins anyway.",
    mobileExperience: "There is no native Chaturbate app on iOS or Android app stores due to content policy restrictions. The mobile website is functional for browsing and watching streams, though the dated design translates poorly to smaller screens. Streams play in-browser and chat works on mobile, but the overall experience is significantly better on desktop where the grid layout and multi-tab browsing make performer discovery more comfortable.",
  },
  "stripchat": {
...
const privacyOverrides: Record<string, string> = {
  ...
  "chaturbate": "Is Chaturbate safe? Given the platform's massive traffic and long operational history, this is one of the most important questions for potential users. Is Chaturbate safe for viewers? Yes — with the strongest privacy default available: you do not need to provide any information at all to watch. Is Chaturbate safe for performers? The verification system is standard for the industry, and the platform's clean security record is reassuring, but performers should always exercise personal security practices. Is Chaturbate legit? Absolutely — one of the longest-running and most established cam platforms globally. Is Chaturbate free? Yes, public broadcasts are completely free to watch. Tokens are only needed for interacting with performers.",
...
const tipsOverrides: Record<string, Tip[]> = {
  ...
  "chaturbate": [
    { title: "Create a Free Account Even If You Never Plan to Spend", description: "While viewing requires nothing, a free account enables chat participation, performer following, and notifications when your favorites go live. With thousands of simultaneous performers, following favorites eliminates the need to search every time you visit." },
    { title: "Start with the 100-Token Package to Test", description: "The chaturbate tokens price starts at $10.99 for 100 tokens. This is enough to tip several performers, test interactive toy responses, and experience the platform's interactive features before committing to larger purchases. Do not buy 1,000 tokens on your first visit." },
    { title: "Read Tip Menus Before Tipping", description: "Every experienced performer has a chaturbate tip menu listing what specific token amounts trigger. Reading the tip menu before tipping ensures your tokens go toward the interaction you actually want rather than being absorbed into general tips with no specific response." },
    { title: "Use Tags and Filters to Navigate the Volume", description: "Chaturbate's overwhelming performer count is manageable with tags. Use category tabs (Female, Male, Couples, Trans), tag filters (#lovense, #ohmibod, #squirt, #new), and the viewer count sort to narrow the massive selection to content that matches your specific interests." },
    { title: "Try the Couples Category for a Different Experience", description: "If you typically watch solo performers, the chaturbate couples category offers a fundamentally different dynamic. Real partners performing together create genuine chemistry and interaction patterns that solo shows cannot replicate. It is one of the most popular categories for a reason." },
  ],
  "stripchat": [
