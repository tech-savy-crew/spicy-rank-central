...
const NotFound = () => {
  ...
  const popular = [...reviewPlatforms].sort((a, b) => b.score - a.score).slice(0, 4);
    ...
    <Layout>
      ...
      <div className="container py-20 max-w-2xl text-center">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12">
          ...
          <Link to="/reviews" className="inline-flex items-center gap-2 bg-secondary text-secondary-foreground font-medium px-5 py-2.5 rounded-lg text-sm hover:bg-surface-hover transition-colors btn-hover">
            All Reviews
          </Link>
