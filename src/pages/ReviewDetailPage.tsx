...
const ReviewDetailPage = () => {
  ...
  const customJsonLd = candyJsonLd || feetFinderJsonLd || onlyFansJsonLd || fanslyJsonLd || dreamGFJsonLd || bumbleJsonLd || chaturbateJsonLd || stripchatJsonLd || tinderJsonLd || fanvueJsonLd || patreonJsonLd || jerkmateJsonLd || crushOnJsonLd || replikaJsonLd || girlfriendGPTJsonLd || snifffrJsonLd || fetishFinderJsonLd;
